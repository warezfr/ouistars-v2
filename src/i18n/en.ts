...
export const en: typeof fr = {
  ...
  meetGreet: {
    ...
    cta: 'Book now',
    wizTitle: 'Book a Meet & Greeter',
    steps: ['Service', 'Airport', 'Details'] as string[],
    chooseService: 'Choose your service type',
    chooseAirport: 'Choose your airport',
    yourDetails: 'Complete your request',
    svcArrival: 'Arrival',
    svcArrivalDesc: 'Welcome at the aircraft door, fast track and escort to the terminal exit.',
    svcTransit: 'Transit',
    svcTransitDesc: 'Full assistance between two flights: a smooth, stress-free connection.',
    svcDeparture: 'Departure',
    svcDepartureDesc: 'Greeting at the terminal entrance, fast track and escort to boarding.',
    onQuote: 'On request',
    otherAirport: 'Other airport',
    otherAirportDesc: 'Tell us your airport — price quoted on request.',
    otherAirportPh: 'Airport name (e.g. Lyon — LYS)',
    back: 'Back',
    edit: 'Edit',
    ...
    flight: 'Flight no.',
    pax: 'Passengers',
    notesPh: 'Details (terminal, luggage, preferred language…)',
    sendEmail: 'Send by e-mail',
    sendWhatsApp: 'Send via WhatsApp',
    needEmail: 'Enter your e-mail to send by e-mail.',
    needFields: 'Please fill the required fields: first name, phone and date.',
    requiredNote: 'Required fields',
    flightSearching: 'Identifying flight…',
    flightNotFound: 'Flight not found on this date — check the number.',
    flightUnknownAirline: 'Valid flight number',
    okTitle: 'Request sent ✓',
    okBody: 'Your Meet & Greeter request has been received. Our team will confirm shortly (24/7).',
    okRef: 'Reference',
    error: 'Error — please retry or contact us on WhatsApp.',
  },
  fleet: {
  ...
  experience: {
    ...
    ritual: [
      { t: 'The preparation', d: 'Flight tracked, route checked, vehicle prepared an hour before your arrival.',
        long: 'An hour before you land, everything is in place: flight tracked live, route checked, vehicle prepared and climate-set. You never wait — we wait for you.' },
      { t: 'The welcome', d: 'A name board, a hand for your luggage, the door held open.',
        long: 'At the exit, a board with your name and a suited chauffeur. Your luggage is taken care of, the door opens — all you have to do is settle in.' },
      { t: 'The journey', d: 'Silence, fresh water, daily press and Wi-Fi — time belongs to you.',
        long: 'Leather interior, hushed silence, fresh water, daily press and onboard Wi-Fi. The journey becomes your own time: work, call, or close your eyes.' },
      { t: 'The attention', d: '24/7 concierge, adjustments en route, absolute discretion.',
        long: 'A change of plans, an extra stop? Our concierge answers 24/7 and adjusts en route. Absolute discretion, from departure to the last door.' },
  ...
  wizard: {
    ...
    tripRoundNote: 'Return included — billed as two transfers.',
