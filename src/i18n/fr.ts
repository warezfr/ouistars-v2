export const fr = {
  ...
  experience: {
    ...
    ritual: [
      { t: 'La préparation', d: 'Vol suivi, itinéraire vérifié, véhicule préparé une heure avant votre arrivée.',
        long: 'Une heure avant votre arrivée, tout est déjà en place : vol suivi en temps réel, itinéraire vérifié, véhicule préparé et climatisé. Vous n’attendez jamais — on vous attend.' },
      { t: 'L’accueil', d: 'Pancarte à votre nom, main tendue pour les bagages, portière ouverte.',
        long: 'À la sortie, une pancarte à votre nom et un chauffeur en costume. Vos bagages sont pris en charge, la portière s’ouvre — vous n’avez plus qu’à vous installer.' },
      { t: 'Le trajet', d: 'Silence, eau fraîche, presse du jour et Wi-Fi — le temps vous appartient.',
        long: 'Intérieur cuir, silence feutré, eau fraîche, presse du jour et Wi-Fi à bord. Le trajet devient un moment à vous : travaillez, appelez, ou fermez les yeux.' },
      { t: 'L’attention', d: 'Conciergerie 24/7, ajustements en route, discrétion absolue.',
        long: 'Un imprévu, un arrêt, un changement de programme ? Notre conciergerie répond 24/7 et ajuste en route. Discrétion absolue, du départ à la dernière portière.' },
  ...
  footer: {
    ...
    terms: 'Mentions légales', privacy: 'Confidentialité', cookies: 'Cookies',
